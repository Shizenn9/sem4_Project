...
public final class viewStaff_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <script>\n");
      out.write("            function confirmDelete(staffId) {\n");
      out.write("                var confirmed = confirm(\"Are you sure you want to delete this staff?\");\n");
      out.write("                if (confirmed) {\n");
      out.write("                    // If confirmed, submit the form\n");
      out.write("                    document.getElementById(\"deleteForm\" + staffId).submit();\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("        </script>\n");
      ...
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                <a href=\"addStaff.jsp\" class=\"btn-download\">\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</p></td>\n");
          out.write("                                                            <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                                                            <td>");
          ...
          out.write("</td>\n");
          out.write("                                                            <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.position}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                                                            <td>");
          ...
          out.write("</td>\n");
          out.write("                                                            <td><span class=\"status process\"><a style=\"color:white;\" href=\"editStaff.jsp?staffId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.staffId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&amp;name=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&amp;address=");
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.staffId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" method=\"post\" action=\"StaffServlet\">\n");
          out.write("                                                                    <input type=\"hidden\" name=\"staffId\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.staffId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
          out.write("                                                                    <button type=\"button\" style=\"border-color:transparent;\" class=\"status completed\" onclick=\"confirmDelete(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${staff.staffId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
