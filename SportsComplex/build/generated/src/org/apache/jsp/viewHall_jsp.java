...
public final class viewHall_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <script>\n");
      out.write("            function confirmDelete(hallId) {\n");
      out.write("                var confirmed = confirm(\"Are you sure you want to delete this hall?\");\n");
      out.write("                    if (confirmed) {\n");
      out.write("                        // If confirmed, submit the form\n");
      out.write("                        document.getElementById(\"deleteForm\" + hallId).submit();\n");
      out.write("                    }\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("\t<title>Hall</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t</li>\n");
      out.write("\t\t\t<li>\n");
      out.write("\t\t\t\t<a href=\"BookingServlet\">\n");
      ...
      out.write("\t\t\t\t\t<h1>Hall</h1>\n");
      out.write("\t\t\t\t\t<ul class=\"breadcrumb\">\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                <a href=\"addHall.jsp\" class=\"btn-download\">\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${halls}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_0.setVar("hall");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                            <td>\n");
          out.write("                                                                <p>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</p></td>\n");
          out.write("                                                            <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                                                            <td><span class=\"status pending\"><a href=\"editHall.jsp?hallId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("&amp;hallName=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">Edit</a></span></td>\n");
          out.write("\t\t\t\t\t\t\t\t<!--<td><span class=\"status completed\">Delete</span></td>-->\n");
          out.write("                                                                <td>\n");
          out.write("                                                                    <form id=\"deleteForm");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" method=\"post\" action=\"HallServlet\">\n");
          out.write("                                                                        <input type=\"hidden\" class=\"status completed\" name=\"hallId\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${hall.hallId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\n");
