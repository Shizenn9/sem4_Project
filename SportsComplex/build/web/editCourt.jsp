...
<html>
    ...
    <div class="container">
        <h1>Edit Court</h1>
        <form method="post" action="editProcessCourt.jsp">
            <input type="hidden" name="courtId" value="${param.courtId}" required>
            <div class="column">
                <label for="courtName">Court Name</label><br>
                <input class="inputBox" type="text" name="courtName" value="${param.courtName}" required><br><br>
            </div>
