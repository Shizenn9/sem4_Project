...
<html>
    <head>
        ...
        <script>
            function displayMessageAndRedirect() {
                var message = "Hall added successfully.";
                alert(message);
                window.location.href = "<%=request.getContextPath()%>/HallServlet";
            }
        </script>
    </head>
    <body>
    ...
    %>
        ...
        <div class="container">
            <h1>Add New Hall</h1>
            <form method="post" action="addHall.jsp">
                <div class="row">
                    <div class="column">
                        <label for="hallName">Hall Name</label>
                        <input class="inputBox" type="text" id="hallName" name="hallName" placeholder="Enter Hall Name" required>
                    </div>
                </div>
