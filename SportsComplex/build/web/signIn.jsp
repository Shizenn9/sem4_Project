...
<head>
    ...
    <title>Sign In &#8211; Megah Holdings Sports Complex</title>
...
<!--SIGN IN FORM PASSWORD VISIBILITY-->
<script>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="title-text d-flex flex-column align-items-center">
                    <h2 class="title m-1" style="font-size:60px; color:white;">Sign <span style="color:red;">In</span>
                    </h2>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="contact-form">
                                            <div class="no-js" id="wpcf7-f392-p23-o1" lang="en-US" dir="ltr">
                                                ...
                                                <form action="LoginServlet" method="post" class="init"
                                                ...
                                                <div
                                                    ...
                                                    <p id="member" style="margin-top:-50px">Not a Representative? <a href="signUp.jsp" class="signup-text">Sign
                                                            Up now</a></p>
                                                </div>
                                                <div
                                                    class="d-flex flex-column align-items-center justify-content-center">
                                                    <p id="sign-in">Sign In as <a href="staffSignIn.jsp"
                                                            class="admin-text">Staff</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
