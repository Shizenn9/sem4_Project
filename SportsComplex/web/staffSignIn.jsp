...
<head>
 <script>
    // Retrieve the logout message from the URL parameter
    var urlParams = new URLSearchParams(window.location.search);
    var logoutMessage = urlParams.get('logoutMessage');
    
    // Display the logout message using JavaScript if it exists
    console.log("Logout Message: " + logoutMessage); // Debugging statement
    if (logoutMessage) {
        alert(logoutMessage);
    }
  </script>
    ...
    <title>Staff Sign In &#8211; Megah Holdings Sports Complex</title>
    ...
    <link rel='stylesheet' id='google-fonts-1-css'
        ...
        type='text/css' media='all' />
    <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin>
    <script src='https://themes.hibootstrap.com/cribe/wp-includes/js/jquery/jquery.min.js?ver=3.6.4'
...
<style type='text/css'>
    body {
        ...
        padding: 0;
        overflow: hidden;
        background-image: url(Images/sports_background3.jpg);
    ...
    .elementor-section {
        ...
        /* Add positioning */
        top: 38px;
        /* Adjust the value to push the card below */
    }
    ...
    .form-group .toggle-password.active:before {
        content: "\f070";
        color: #555;
    }
    ...
    /* Placeholder color for email textbox */
    #email-field::placeholder {
        color: grey;
        linear-gradient(to bottom right, #e31c25, #000000)
    }

    /* Placeholder color for password textbox */
...
<header class="header-wrap style3 bg-firfly p-3">
    <div class="header-top">
        <div class="row">
            <div class="col-md-12">
                <div class="title-text d-flex flex-column align-items-center">
                    <h2 class="title m-1" style="font-size:60px; color:red;">Staff <span style="color:white;">Sign In</span>
                    </h2>
                </div>
            </div>
        </div>
...
<body>
    ...
    <div class="elementor-section elementor-top-section elementor-element elementor-element-404cb4a elementor-section-full_width elementor-section-height-default elementor-section-height-default"
        data-id="404cb4a" data-element_type="section">
        <div class="elementor-container elementor-column-gap-no">
            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2ad51d9"
                data-id="2ad51d9" data-element_type="column">
                <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-6a8b1a0 elementor-widget elementor-widget-TimeTable-widget"
                        ...
                        <div class="elementor-widget-container" style="display: flex; justify-content: center;">
                            <section class="contact-wrap section-padding" style="max-width: 600px;">

                                    <div class="container">
                                        <div class="section-title-contact">
                                            <!--<h2 class="title" style="font-size:60px; color:white;" >Sign <span style="color:red;">In</span></h2>-->
                                        </div>
                                        <div class="contact-form">
                                            <div class=" no-js" id="wpcf7-f392-p23-o1" lang="en-US" dir="ltr">
                                                <div class="screen-reader-response">
                                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                                    <ul></ul>
                                                </div>
                                                <form action="adminLoginServlet" method="post" class="init"
                                                    ...
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="password-field" size="40"
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="submit" class="default-btn btn v7"
                                                                style="width: 76%;" value="Sign In">
                                                        </div>
                                                    </div>
                                                </form>
                                                <div
                                                    class="d-flex flex-column align-items-center justify-content-center spacing-label">
                                                    <p id="member">Not a Staff? <a href="signIn.jsp" class="signup-text">Sign In as Representative</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!--FOOTER-->
<footer class="footer-wrap style3 bg-firfly">
...
<script type='text/javascript' id='jquery-yith-wcwl-js-extra'>
    ...
    var yith_wcwl_l10n = {
        ...
        "nonce": {
            "add_to_wishlist_nonce": "e87cad34d9",
            "remove_from_wishlist_nonce": "0e247541a0",
            "reload_wishlist_and_adding_elem_nonce": "5484595811",
            "load_mobile_nonce": "18b49ad09f",
            "delete_item_nonce": "c776847836",
            "save_title_nonce": "bb75ec66fd",
            "save_privacy_nonce": "093e3e0ead",
            "load_fragments_nonce": "41541f3c44"
        },
...
<script src='https://themes.hibootstrap.com/cribe/wp-content/plugins/contact-form-7/includes/swv/js/index.js?ver=5.7.6'
    id='swv-js'></script>
...
<script id='elementor-frontend-js-before'>
    var elementorFrontendConfig = {
        ...
        "post": {
            "id": 23,
            "title": "Contact%20Us%20%E2%80%93%20Cribe",
            "excerpt": "",
            "featuredImage": "https:\/\/themes.hibootstrap.com\/cribe\/wp-content\/uploads\/2021\/09\/breadcrumb-2-1024x320.jpg"
        }
    };
</script>
